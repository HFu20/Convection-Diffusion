function [ matrix_Hl , matrix_Hr , matrix_Delta_x_2 , matrix_Delta_x, matrix_A12,matrix_A6] = Matrix_periodic(n, gamma, dx, dt)
...
matrix_A12 =sparse(1:n, 1:n, 5/6, n, n) + sparse(1:n-1, 2:n, 1/12, n, n) ...
                     + sparse(2:n, 1:n-1, 1/12, n, n);
matrix_A12(1,end)=1/12;
matrix_A12(end,1)=1/12;

matrix_A6 = sparse(1:n, 1:n, 2/3, n, n)  + sparse(1:n-1, 2:n, 1/6, n, n) ...
                      + sparse(2:n, 1:n-1, 1/6, n, n);
matrix_A6(1,end)=1/6;
matrix_A6(end,1)=1/6;

 matrix_Hl = matrix_A12 - dt/2 * gamma/2  * matrix_Delta_x_2;
 matrix_Hr = matrix_A12 + dt/2 * gamma/2  * matrix_Delta_x_2;
