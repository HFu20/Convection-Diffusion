function [ kxi_plus, yinta_k,count ] = fun_kxi_plus( dt, u_tidle, U0, kxi, dx )
...
for i = 1: length( u_tidle )
    ...
    Gminus_4 = Gminus_4 + U0 (i)* w ;

end
Gminus = Gminus_1 + Gminus_2 + Gminus_3 - Gminus_4;

while abs( kxi_k - kxi_minus ) > eps   %eps =  1.0e-6;
