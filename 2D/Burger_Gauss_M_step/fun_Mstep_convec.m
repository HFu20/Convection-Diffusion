...
%         + mt/2 * ( fun_Source ( X,Y, gamma, t_k   ) + fun_Source ( X,Y, gamma,  t_kplus ) ) ; %g;
%% ADI
  ...
  u_n4_hat    = u_nPlusHf2 -  matrix_A2x\matrix_Delta_x*lam_x* 0.5*(fun_f(u_nPlusHf2)+fun_f(u_nPlusHf3) ) ...%f
        -   lam_y/2* (fun_g(u_nPlusHf3)+fun_g(u_nPlusHf2) ) * matrix_Delta_y' /matrix_A2y' ...
